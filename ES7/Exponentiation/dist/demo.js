...
console.log('3 ** 2.5 = ', Math.pow(3, 2.5)); // 15.588457268119896
console.log('10 ** -1 = ', Math.pow(10, -1)); // 0.1
console.log('NaN ** 2 = ', Math.pow(NaN, 2)); // NaN

console.log('2 ** 3 ** 2 = ', Math.pow(2, Math.pow(3, 2))); // 512
console.log('2 ** (3 ** 2) = ', Math.pow(2, Math.pow(3, 2))); // 512
console.log('(2 ** 3) ** 2 = ', Math.pow(Math.pow(2, 3), 2)); // 64
